...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 05, 2017 at 09:38 AM
...
(1, 2, 'Bánh canh', 'Nguyên liệu: 3 quả dưa chuột, 3 quả cà chua, 1/2 quả dứa, xà lách xoăn, hành tây, tỏi, đường, dấm, ớt...', 'Được làm từ bột gạo, bột mì, hoặc bột sắn hoặc bột gạo pha bột sắn cán thành tấm và cắt ra thành sợi to và ngắn với nước dùng được nấu từ tôm, cá, giò heo... thêm gia vị tùy theo từng loại', 25000, 'nước ngọt, khăn lạnh', 'Banh-Canh-Thit.jpg', '2013-12-28', 'đĩa', 0),
...
CREATE TABLE `users` (
  ...
  `pwd_reset_token` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `username`, `password`, `fullname`, `birthdate`, `gender`, `address`, `email`, `phone`, `role`, `pwd_reset_token`, `pwd_reset_token_creation_date`, `status`) VALUES
(47, 'huonghuong222', '$2y$10$7tmSVC3I6f.sQFYPscTSVuZloEBaeQb.HyToXVZUHuaezLaZN4Si.', 'Hương Hương', '2017-09-22', 'nữ', 'Hoàng Diệu 2, Thủ Đức', 'huonghuong08.php@gmail.com', '2333434', 'admin', '314fklw1ce5cah80kseu4ynket7y08ax', '2017-09-17 09:34:13', 1),
(48, 'huong01', '$2y$10$GZu42i9PmHTN2xeYdpSZsuUh6ODOyqioq8P8c1Hkawy5tEpffxV1q', 'Hương Hương', '2017-09-09', 'nam', 'Hoàng Diệu 2, Thủ Đức', 'hudsdsdongnguyenak96@gmail.com', '21313131', 'guest', NULL, NULL, 1),
(52, 'huonghuong', '$2y$10$ZfThD7/DeP0RWCVFjw8JIuR2UuD7eCtsaUuhkDPL0Z2lnk0zBm/ES', 'Hương Hương ssss', '2017-09-07', 'other', 'Lê Thị Riêng', 'huongnguyenak96@gmail.com', '234567324456', 'editor', NULL, NULL, 1);
